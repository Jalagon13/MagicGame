...
public class ChunkManager : NetworkBehaviour
{
    ...
    public void SinglePlayerUpdatePlayerChunks()
    {
    ...
    private bool TryToUnloadChunk(Vector2Int chunkPos)
    {
    ...
    private bool TryToLoadChunk(Vector2Int chunkPos)
    {
    ...
    public ChunkGameData GetChunk(Vector2Int position)
    {
        ...
        var chunk = GetChunksFromActiveEnvironment()[chunkCoord];
        return chunk;
    }
    ...
    public Dictionary<Vector2Int, ChunkGameData> GetOverworldChunks()
    {
        return _forestChunks;
    }

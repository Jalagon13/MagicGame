...
public class ChunkNetworkManager : NetworkBehaviour
{
    ...
    private SyncChunkData ConvertToSyncChunkData(ChunkGameData chunkGameData)
    {
        ...
        {
            byte id = (byte)_tileDataBaseSO.TileObjectSOList.IndexOf(tile.TileSO);
        ...
        {
            byte id = (byte)_worldObjectDataBaseSO.GetByteIDFromWorldAsset(asset.Asset);
    ...
    private ChunkGameData ConvertToGameChunkData(SyncChunkData syncChunkData)
    {
        ...
        {
            TileSO tileSO = _tileDataBaseSO.GetTileObjectSOFromID(syncTile.ID);
        ...
        {
            WorldObject worldObject = _worldObjectDataBaseSO.WorldObjectList[syncAsset.ID];

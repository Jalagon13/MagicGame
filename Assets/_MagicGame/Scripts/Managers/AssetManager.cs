...
public class AssetManager : NetworkBehaviour
{
    ...
    {
        byte assetID = _worldObjectDataBaseSO.GetByteIDFromWorldAsset(worldObject);
    ...
    private void PlaceResourceAssetServerRpc(Vector2Int position, byte assetID)
    {
        ...
        WorldObject asset = _worldObjectDataBaseSO.WorldObjectList[assetID]; 
    ...
    private void PlaceResourceAssetClientRpc(Vector2Int position, byte assetID)
    {
        ...
        WorldObject worldAsset = _worldObjectDataBaseSO.WorldObjectList[assetID];
    ...
    public void HitResourceAsset(Vector2Int position, ushort incomingDamage)
    {
        ...
        {
            byte assetID = _worldObjectDataBaseSO.GetByteIDFromWorldAsset(resourceObjectFound);
    ...
    {
        ResourceObject resourceAsset = _worldObjectDataBaseSO.WorldObjectList[assetID] as ResourceObject;
        ...
        if(currentAssetHPAfterDamage > 0)
        {
            ...
            {
                WorldAssetID = (byte)_worldObjectDataBaseSO.WorldObjectList.IndexOf(resourceAsset),

...
public class SpellItemSO : MagicItemSO
{
	...
	{
		GameManager.Instance.SpawnSpellProjectile(this, Player.LocalClientInstance.CurrentPlayerBiome.Value, ActionManager.MouseWorldPosition, Speed, Damage + wandSO.BaseDamage, Lifetime, Knockback, Mathf.Max(0, Accuracy + wandSO.Accuracy));

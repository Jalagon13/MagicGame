...
public class BuildItemSO : ItemSO
{
	...
	public override float ExecuteItemAction(InventoryItem inventoryItem, PlayerHand playerHand)
	{
		...
		{
			Environment.Instance.PlaceTile(pos, _wallTile, Player.LocalClientInstance.CurrentPlayerBiome.Value);
			Pathfinding.Instance.AddPfWallTile((Vector2Int)pos, Player.LocalClientInstance.CurrentPlayerBiome.Value);

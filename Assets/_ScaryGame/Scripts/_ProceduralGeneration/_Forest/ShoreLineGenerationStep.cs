...
public class ShoreLineGenerationStep : GenerationStep
{
    ...
    public override void Execute(BaseGenerationData genData)
    {
        ...
        HashSet<Vector2Int> allInitialShoreTiles = GenerationUtils.GetEdgeTiles(_tilesToSearchFor, new List<TileSO>() { forestGenData.WaterTerrainTile }, DirectionsHelper.DirectionOffsets8, forestGenData.MostFrontRenderedTileMatrix);
